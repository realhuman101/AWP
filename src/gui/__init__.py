...
def start() -> None:
	...
	# Creating buttons
	button1 = tk.Button(window, text='Manual Prediction', font=('Garamond', 20), command = window.destroy)
	button1.place(relx = 0.76, rely = 0.32, anchor = 'center')
	button2 = tk.Button(window, text='Automated Prediction', font=('Garamond', 20), command = window.destroy)
