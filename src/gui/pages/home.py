...
def start(GUI) -> None:
	...
	# Creating buttons
	button1 = RoundedButton(GUI.window, text='MANUAL PREDICTION', width=300, height=45, font=('Montserrat', 20), bg='#323466', clicked=GUI.present)
	button1.place(relx=0.76, rely=0.32, anchor='center')
	button2 = RoundedButton(GUI.window, text='AUTOMATED PREDICTION', width=300, height=45, font=('Montserrat', 20), bg='#323466', clicked=GUI.present)
